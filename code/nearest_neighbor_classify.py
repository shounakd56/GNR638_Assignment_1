...
def nearest_neighbor_classify(train_image_feats, train_labels, test_image_feats):
    ...
    '''
    # Adding the target categories for KNN
    CATEGORIES = ['forest', 'agricultural', 'chaparral', 'baseballdiamond', 'denseresidential', 'airplane', 'freeway', 'golfcourse', 'beach', 'buildings', 'mobilehomepark', 'sparseresidential', 'parkinglot', 'harbor', 'runway', 'intersection', 'overpass', 'river', 'storagetanks', 'mediumresidential', 'tenniscourt']
